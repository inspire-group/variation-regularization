...
if __name__ == '__main__':
    ...
    # set attacks manually
    args.attack = [
        'LinfAttack(model, dataset_name="cifar", bound=12, num_iterations=10)',
        'L2Attack(model, dataset_name="cifar", bound=255, num_iterations=10)',
        'StAdvAttack(model, num_iterations=20)',
        'ReColorAdvAttack(model, num_iterations=20)'
    ]
    ...
    validation_attacks = [
        NoAttack(),
        LinfAttack(model, bound=12, dataset_name=args.dataset,
                   num_iterations=VAL_ITERS),
        L2Attack(model, bound=255, dataset_name=args.dataset,
                 num_iterations=VAL_ITERS),
